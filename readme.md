...
## Миссия
Сервер LIRA предназначен для подмены внешних api при тестиронии исходной системы. LIRA очень прост в настройке при сохранение максимальной функциональности

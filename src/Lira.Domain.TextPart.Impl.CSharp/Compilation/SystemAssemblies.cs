...
static class SystemAssemblies
{
    public static IImmutableList<string> Locations { get; }

    static SystemAssemblies()
    {
        ...
        Locations = Names.Select(name => Path.Combine(assemblyPath, name)).ToImmutableList();
    }
